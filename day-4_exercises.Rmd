...
Now that we have created the plot, we can reference it in the text.

e.g. *Figure `\@ref(fig:rooms-village-scatter)` shows the relationship between the variables room and village, but doesn't do a very good job at it.*
